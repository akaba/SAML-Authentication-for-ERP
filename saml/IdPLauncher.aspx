<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IdPLauncher.aspx.cs" Inherits="saml.IdPLauncher" %>
<!DOCTYPE html>
...
<body runat="server" id="bodySSO">
    ...
    <div style="width: 700px;">
        <div style="font-size: x-large;">
            Harmony SAML IdentityProvider SSO Launcher</div>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtIssuer" runat="server" Text="harmonytx.org"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtSPURL" runat="server" Text="https://www.mylearningplan.com/mvc/saml/Login/17524" Width="400px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtTarget" runat="server" Text="https://www.mylearningplan.com/mvc/saml/Login/17524" Width="400px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <fieldset>
            ...
            <table runat="server" id="tblAttrs">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox14" runat="server" Text="10"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox12" runat="server" Text="akaba@harmonytx.org"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox6" runat="server" Text="Ali"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox10" runat="server" Text="Kaba"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox50" runat="server" Text="akaba@harmonytx.org"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox20" runat="server" Text=""></asp:TextBox>
                    </td>
                    <td>
